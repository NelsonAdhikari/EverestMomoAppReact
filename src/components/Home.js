...
import "../App.css"
import momo from "../images/Frame 16.png"
import eclipse from "../images/Ellipse 9.png"
import { FaArrowRight } from "react-icons/fa";
import image2 from "../images/Group 3.png"
import image3 from "../images/Image.png"
import buffmomo from "../images/pngwing 2.png"
import { IoPlayCircleOutline } from "react-icons/io5";
import buffFry from "../images/pngegg 1.png"
import Cmomo from "../images/C Momo.png"
    ...
    <>
      ...
      <div className='body-container2'>
          ...
          <div className='choosebtnmain'>
           ...
           <button className='choosebtn' style={{border:'0'}}>Chicken</button>
           <button className='choosebtn' style={{border:'0'}}>Veg</button>
          </div>
          <div className='menuselect'>
             <div className='fooditem1'>
                <img src={buffmomo} alt=""  />
                <h3 style={{paddingTop:'4rem'}} >Buff Momo</h3>
                <h2>Rs.<text className='color'>150</text></h2>
             </div>
             <div className='fooditem2'>
                <img src={buffFry} alt="" />
                <h3 style={{paddingTop:'4rem'}} >Buff Fry Momo</h3>
                <h2>Rs.<text className='color'>180</text></h2>
             </div>
              <div className='fooditem3'>
                <img src={Cmomo} alt="" />
                <h3 >Buff C Momo</h3>
                <h2>Rs.<text className='color'>200</text></h2>
              </div>
          </div>
          <div>
      ...
      <div className='body-container3'>
         ...
         <button className='expbutton4' ><IoPlayCircleOutline style={{scale:'2'}}/> Watch the Video</button>
         </div>
               ...
               <div className='cardbody'>
                  ...
                  <form>
                     ...
                     <select name="service" id="choices">
                      ...
                      <select name="" id="">
                        <option value="" placeholder='Choose'> +977</option>
                      </select>
