    ...
    <div className='card1'>
      <Card>
        <CardBody>
            ...
            <p>New Baneshwor -41201, <br /> Kathmandu, Bagmati, Nepal</p>
        </CardBody>
      </Card>
    </div>
    <div className='card1'>
      <Card>
        <CardBody>
            ...
            <p><span className='color3'>Mobile:</span> (+977) 980 5689789 <br />(+977) 9841 275897</p>
            <p><span className='color3'>Tel:</span> 01-4783972</p>       
        </CardBody>
      </Card>
    </div>
    <div className='card1'>
